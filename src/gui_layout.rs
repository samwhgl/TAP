...
impl GuiWindow {
                    ...
                    ui.allocate_ui_with_layout(
                        ...
                        |ui| {
                            ...
                            ui.horizontal(|ui| {
                                ...
                                let input_widget =
                                    egui::TextEdit::singleline(&mut self.chats_inputs[i]);
    ...
    fn draw_right_panel(&mut self, ui: &mut egui::Ui) {
        let commands = [
            ...
            ("GROUP LEAVE", ButtonAction::ImmediateSend),
                    ...
                    |ui| {
                        egui::Frame::NONE
                            ...
                            .show(ui, |ui| {
                                ...
                                let (rect, _) =
                                    ui.allocate_exact_size(square_size, egui::Sense::click());
                                ...
                                let directions = [
                                    (
                                        "north",
                                        [
                                            center + egui::Vec2::new(0.0, -offset - height),
                                            center + egui::Vec2::new(-half_base, -offset),
                                            center + egui::Vec2::new(half_base, -offset),
                                        ],
                                    ),
                                    (
                                    ...
                                    (
                                        "west",
                                        [
                                            center + egui::Vec2::new(-offset - height, 0.0),
                                            center + egui::Vec2::new(-offset, -half_base),
                                            center + egui::Vec2::new(-offset, half_base),
                                        ],
                                    ),
                                    (
                                ...
                                for (cmd, points) in directions {
                                    ...
                                    let is_clicking =
                                        is_hovered && ui.input(|i| i.pointer.any_down());
        ...
        egui::Panel::bottom("bottom_panel")
            ...
            .show_inside(ui, |ui| {
                ...
                ui.horizontal(|ui| {
                    ...
                    let enter_pressed =
                        command_input.lost_focus() && ui.input(|i| i.key_pressed(egui::Key::Enter));
    ...
    fn ui(&mut self, ui: &mut egui::Ui, _frame: &mut eframe::Frame) {
        ...
        while let Ok(msg) = self.rx.try_recv() {
            if msg.starts_with("EVT GLOBAL CHAT") {
                ...
                self.chats_logs[0].push(ChatLog {
                    username: split_msg[3].to_string(),
                    message: split_msg[4].to_string(),
                });
                new_chat_msgs[0] = true;
            } else if msg.starts_with("EVT ROOM CHAT") {
                let split_msg: Vec<&str> = msg.splitn(5, ' ').collect();
                self.chats_logs[1].push(ChatLog {
                    username: split_msg[3].to_string(),
                    message: split_msg[4].to_string(),
                });
                ...
                let split_msg: Vec<&str> = msg.splitn(5, ' ').collect();
                self.chats_logs[2].push(ChatLog {
                    username: split_msg[3].to_string(),
                    message: split_msg[4].to_string(),
                });
